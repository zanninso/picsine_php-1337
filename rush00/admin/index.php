...
<!-- 
        ...
        <div id="new-prod">
            <div class="section-title"><a href="">Recent Products</a></div>
            <div id="section-inner-new">
                <div class="section-inner-new-item"></div>
                <div class="section-inner-new-item"></div>
                <div class="section-inner-new-item"></div>
                <div class="section-inner-new-item"></div>
                <div class="section-inner-new-item"></div>
        ...
        <div id="cat-prod">
            <div class="section-title"><a href="">Shop by Categorie</a></div>
            <div id="section-inner-cat">
                <div class="section-inner-cat-item"></div>
                <div class="section-inner-cat-item"></div>
                <div class="section-inner-cat-item"></div>
                <div class="section-inner-cat-item"></div>
                <div class="section-inner-cat-item"></div>
